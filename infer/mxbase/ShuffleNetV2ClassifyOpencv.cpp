...
APP_ERROR ShuffleNetV2ClassifyOpencv::Init(const InitParam &initParam) {
...
APP_ERROR ShuffleNetV2ClassifyOpencv::DeInit() {
    model_->DeInit();
    post_->DeInit();
...
APP_ERROR ShuffleNetV2ClassifyOpencv::ReadImage(const std::string &imgPath, cv::Mat &imageMat) {
    imageMat = cv::imread(imgPath, cv::IMREAD_COLOR);
    return APP_ERR_OK;
}

APP_ERROR ShuffleNetV2ClassifyOpencv::ResizeImage(const cv::Mat &srcImageMat, cv::Mat &dstImageMat) {
...
APP_ERROR ShuffleNetV2ClassifyOpencv::CVMatToTensorBase(const cv::Mat &imageMat, MxBase::TensorBase &tensorBase) {
...
APP_ERROR ShuffleNetV2ClassifyOpencv::Crop(const cv::Mat &srcImageMat, cv::Mat &dstImageMat) {
...
APP_ERROR ShuffleNetV2ClassifyOpencv::Inference(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR ShuffleNetV2ClassifyOpencv::PostProcess(const std::vector<MxBase::TensorBase> &inputs,
...
APP_ERROR ShuffleNetV2ClassifyOpencv::SaveResult(const std::string &imgPath,
...
APP_ERROR ShuffleNetV2ClassifyOpencv::Process(const std::string &imgPath) {
    cv::Mat imageMat;
